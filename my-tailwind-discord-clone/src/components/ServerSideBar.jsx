...
function Section({sectionName = "Text Channels", channels }){
...
function ChannelItem({channel, isSectionExpanded = true }){
    return (
      <div
        className={`${!isSectionExpanded && !channel.active ? "hidden" : ""}`}
      >
        <div
        ...
        >
          ...
          <p 
            className="ml-1 overflow-hidden text-ellipsis whitespace-nowrap text-base font-medium"
            >
            {channel.name}
          </p>
        </div>
